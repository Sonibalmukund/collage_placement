				...
				<div class="row align-items-center">
					...
					<div class="col-md-8">
						<h4 class="font-20 weight-500 mb-10 text-capitalize">
							Welcome back <div class="weight-600 font-30 text-blue"><h1>{{ $companyUser->name }}</h1></div>
						</h4>
						...
						<div class="d-flex flex-wrap align-items-center">
							...
							<div class="widget-data">
                                <a href="{{ route('applied.job') }}">
                                    <div class="h4 mb-0">Total Students Applied</div>
                ...
                <div class="col-xl-4 mb-30">
					<div class="card-box height-100-p widget-style1">
						<div class="d-flex flex-wrap align-items-center">
							...
							<div class="widget-data">
                                <a href="{{ route('applied.job') }}">
                                    <div class="h4 mb-0">Total Applied Jos</div>
                                    <div class="weight-600 font-14">{{ $allJobsAppliedCount }}</div>
                                </a>
							</div>
						</div>
					</div>
