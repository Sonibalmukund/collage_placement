				...
				<div class="dropdown">
					<a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
						<span class="user-icon">
							<img src="{{ asset('storage/'.$student->profile_photo) }}" alt="">
						</span>
						<span class="user-name">{{ $student->username }}</span>
					</a>
					<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
						<a class="dropdown-item" href="{{ route('student.profile',$student->id) }}"><i class="dw dw-user1"></i> Profile</a>
		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li> <a href="{{ route('student.applied.jobs') }}">
                    ...
                    <li>
						<a href="{{ route('student.applied.jobs') }}" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-library"></span><span class="mtext">Applied Jobs</span>
						</a>
					</li>
				</ul>
			</div>
