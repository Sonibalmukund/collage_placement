		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
                    ...
                    <li>
						<a href="{{ route('admin.company') }}" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-library"></span><span class="mtext">Company</span>
						</a>

					</li>
					<li> <a href="{{ route('admin.jobs') }}">
						<a href="{{ route('admin.jobs') }}" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-library"></span><span class="mtext">Listed Jobs</span>
						</a>
					</li>
                    <li>
						<a href="{{ route('admin.student') }}" class="dropdown-toggle no-arrow">
