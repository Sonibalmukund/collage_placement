                ...
                @endphp
					<a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
						<span class="user-icon">
							<img src="{{ asset('storage/'.$companyUser->logo)}}" alt="">
						</span>

						<span class="user-name">{{ $companyUser->name }}</span>
					</a>
					<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
						<a class="dropdown-item" href="{{ route('job.profile',$companyUser->id) }}"><i class="dw dw-user1"></i> Profile</a>
		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
                    <li>
						<a href="{{ route('company.dashboard') }}" class="dropdown-toggle no-arrow">
                    ...
                    <li>
						<a href="{{ route('jobs.index') }}" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-library"></span><span class="mtext">Jobs</span>
						</a>

					</li>
					<li>
						<a href="{{ route('applied.job') }}" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-library"></span><span class="mtext">Applied Students</span>
						</a>
					</li>
